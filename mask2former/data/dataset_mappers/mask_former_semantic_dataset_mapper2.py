...
class MaskFormerSemanticDatasetMapper2:
    ...
    def from_config(cls, cfg, is_train=True):
        ...
        if cfg.INPUT.COPY_PASTE.ENABLED:
            augs.append(CopyPaste(
                dataset_name=dataset_names[0],
                blend=cfg.INPUT.COPY_PASTE.BLEND,
                sigma=cfg.INPUT.COPY_PASTE.SIGMA,
                resize_range=cfg.INPUT.COPY_PASTE.RESIZE_RANGE,
                crop_size=cfg.INPUT.COPY_PASTE.CROP_SIZE,
                pad_value=cfg.INPUT.COPY_PASTE.PAD_VALUE,
                seg_pad_value=cfg.INPUT.COPY_PASTE.SEG_PAD_VALUE,
                flip_prob=cfg.INPUT.COPY_PASTE.FLIP_PROB,
                prob=cfg.INPUT.COPY_PASTE.PROB,
                pre_augs=copy.deepcopy(augs),
                use_scale_jittor=cfg.INPUT.COPY_PASTE.USE_SCALE_JITTOR
            ))
