...
def dm_train_dicts(root):
    dm_root = osp.join(root, "DiffusionMade5")
    ...
    seg_dir = osp.join(dm_root, 'out-combine', 'out_ann_dir', 'tanh2-0.2-4.0-dcrf-0.05-0.95')
...
def register_dm5_seg(root):
    train_name = 'dm5_seg_train'
